...
if __name__ == "__main__":
    ...
    """
    grid = Grid.grid_negativo(penalizacion=-1.0)
    ...
    while True:
        ...
        while True:
            ...
            for s in estados:
                ...
                nueva_v = 0
                if s in politica:
                    # El viento nos empuja, tenemos que tener en cuenta
                    # las demás acciones
                    for a in grid.posiblesAccionesBasicas():
                        ...
                        nueva_v += p * (r + GAMMA * V[grid.estado_actual()])
        ...
        for s in estados:
            if s in politica:
                ...
                for accion in grid.posiblesAccionesBasicas():
                    ...
                    for a2 in grid.posiblesAccionesBasicas():
                        p = 0
                        if accion == a2:
                            p = 0.5
                        else:
                        ...
                        r = grid.mover(a2) # Obtenemos la recompensa del estado
                        v += p * (r + GAMMA * V[grid.estado_actual()])
